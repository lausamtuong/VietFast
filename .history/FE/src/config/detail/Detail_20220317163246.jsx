...
const Detail = () => {
  ...
  const deleteComment = (item)=>{
   ...
   setComment(comment.filter(state=> state.time!=));
      ...
      <div className="detail__comment">
        <div className="comment-head">
          <div className="comment-head-avt">
            <img src={user?.currentUser?.image?user?.currentUser?.image:avt} alt="avt" />
          </div>
      ...
      <div className="render__comment">
        {
          ...
          <div className="render-box" key={index}>
            ...
            <div className="comment-handle">
              ...
              {user?.currentUser?.isAdmin?(<div className='comment-delete'  onClick={()=>deleteComment(item)}>
                Xóa
              </div>):''}
