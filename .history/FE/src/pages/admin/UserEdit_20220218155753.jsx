      ...
      <div className="userEdit__container">
        <div className="userShow">
          <div className="userShowTitle">
            <Avatar src={avt} zoomed bordered size="xl" color="success" />
            <div className="userShowTopTitle">
              <p className="name">{user.username}</p>
              <span className="email">lalatuong@gmail.com</span>
            </div>
          </div>
          <div className="userShowLabel">Account Detail</div>
          <div className="userShowIcon">
            <DriveFileRenameOutlineIcon />
            <span>Làu Lâm Tường</span>
          </div>
          <div className="userShowIcon">
            <LocalPhoneIcon />
            <span>0359209611</span>
          </div>
          <div className="userShowIcon">
            <HomeIcon />
            <span>43, Phố 3, ấp 2, Phú Lợi</span>
          </div>
        </div>
