...
const UserEdit = (props) => {
  ...
  return (
    <Routes>
      <Route path="/" element={<UserEditDetail user={props.user} renderRow={props.renderRow} />} />
    </Routes>
  );
};
...
const UserEditDetail = ({ user,renderRow }) => {
  ...
  const sendData = async() => {
    ...
    const newData= {...data,image:base64?base64:user.image}
  ...
  return (
    <DashboardWrapper>
      ...
      <div className="userEdit__header">
        ...
        <Button size="lg" shadow auto onClick={renderRow}>
          Save
        </Button>
      </div>
