...
const Register = () => {
    ...
    onSubmit:  (values) => {
      ...
      const newUser = {
        ...
        email: values.email,
         ...
         axios({
          method: 'POST',
          url: "http://localhost:8080/WEB/BE/index.php",
          data: newUser,
          
      }).then(res=>{
        console.log(res.data)
        if(res.data=='usernameError'||res.data=='emailError') alert('Tài khoản hoặc email đã có người sử dụng!')
      else navigate('/login')})
  ...
  return (
    <div className="register__form">
      <form className="form__register" onSubmit={formik.handleSubmit} action='register'>
