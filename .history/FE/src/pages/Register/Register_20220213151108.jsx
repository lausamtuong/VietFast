...
const Register = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      axios.post("http://localhost:8080/WEB/BE/",newUser ).then(function(response) {
  ...
  return (
    <div className="register__form">
      <div className="form__register">
        ...
        <Button type="submit" variant="contained" disabled={disabled} onSubmit={formik.handleSubmit}>
          Đăng Kí
        </Button>
