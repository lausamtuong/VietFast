...
import { Checkbox, Mail, Input,Button, Modal, Row, Text } from "@nextui-org/react";
const ListCar = [
  {
    img: LuxA20_,
    gif: LuxA20,
  ...
  return (
    <div className="Home__wrapper">
      ...
      <div className='model_contact'>
        <img src='https://vinbase.ai/api/v1/file/download/61d01bf2e9f9a5fc84aee1cb' alt=''  onClick={handler}/>
        <Modal
        closeButton
        animated={false}
