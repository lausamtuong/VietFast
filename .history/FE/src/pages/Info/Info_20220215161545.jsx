...
import { logoutUser, updateUserPassword } from "../../reduxToolkit/apiRequest";
const Info = () => {
      ...
      <div className="Info">
        ...
        <div className="overlayz none edit">
          ...
          <div className='edit_body'>
            <div className='edit_body-name'></div>
            <div className='edit_body-email'></div>
          </div>
          <div className='edit_butgto'></div>
        </div>
      </div>
    </>
  );
