...
const Help = () => {
  ...
  return (
    <div>
      ...
      <div className="box">
        <TextField id="outlined-basic"  sx={{ width: '400px' }} label="Họ Và Tên" variant="outlined" />
        <TextField
        ...
        <TextField id="outlined-basic"  sx={{ width: '400px' }} label="Số điện thoại" variant="outlined" />
        <TextField id="outlined-basic"  sx={{ width: '400px' }} label="Email" variant="outlined" />
        <TextField
