...
const Help = () => {
  ...
  return (
    <div>
      ...
      <div className="box">
        <TextField id="outlined-basic"  sx={{ width: '350px' }} label="Họ Và Tên" variant="outlined" />
        <TextField
        ...
        <TextField id="outlined-basic"  sx={{ width: '350px' }} label="Số điện thoại" variant="outlined" />
        <TextField id="outlined-basic"  sx={{ width: '350px' }} label="Email" variant="outlined" />
        <TextField
      ...
      <button className="button_send">Gửi thông tin</button>
    </div>
  );
};
