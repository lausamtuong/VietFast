...
const authSlice = createSlice({
    ...
    reducers:{
       ...
       registerFalse:(state)=>{
        ...
        sendCommentSucce:(state)
    }
})

export const {loginStart,logout,filter,loginSuccess,loginFalse,registerFalse,registerSuccess,registerStart,loginInit} = authSlice.actions
