...
const authSlice = createSlice({
    ...
    reducers:{
       ...
       registerFalse:(state)=>{
        ...
        filter:(state,action)=>{
            state.API.type= action.type_
            state.API.fuel= action.fuel
        }
        ,logout:(state)=>{
...
export const {loginStart,updateSuccess,commentSuccess,commentError,logout,filter,loginSuccess,loginFalse,registerFalse,registerSuccess,registerStart,loginInit} = authSlice.actions
