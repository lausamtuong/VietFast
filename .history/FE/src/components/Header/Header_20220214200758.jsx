...
const Header = () => {
  ...
  const more_user=  document.querySelector('.more__user').addEventListener('moveover',()=>{
    document.querySelector('.more__user').classList().remove('active-user')
  })
  useEffect(() => {
        ...
        <div className="header__right ">
          ...
          {isLogin ? (
            <div className="relative">
              ...
              <div className="more__user active-user">
