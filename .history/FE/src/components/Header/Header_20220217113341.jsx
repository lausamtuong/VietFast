...
const Header = () => {
  ...
  useEffect(() => {
    setName(useSelector((state) => state?.auth?.login?.currentUser.username));
    setAnhdaidien(useSelector((state) => state?.auth?.login?.currentUser.image))
  
  }, [useSelector((state) => state?.auth?.login.uploadAvt)]);
  return (
          ...
          {isLogin ? (
            <div className="relative">
              <div className="header__user-info">
                <div className="image">
                  <img alt="user-img" src={anhdaidien} />
                </div>
