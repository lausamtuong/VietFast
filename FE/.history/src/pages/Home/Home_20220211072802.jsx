...
const Home = () => {
  return (
    <div className="Home__wrapper">
                ...
                <div className="swiper_item">
                  <div className="swiper_item-head">
                    ...
                    <p className="swiper_item-des">
                      ...
                      Pininfarina, VietFast mang đến chất lượng thiết kế đẳng cấp
                      cho từng dòng xe. Theo đuổi triết lý trải nghiệm chạm sinh
                      học, những chiếc xe VietFast sở hữu vẻ ngoài sang trọng đặc
      ...
      <div className="block-new-home-carả></div>
    </div>
  );
};
