              ...
              <SwiperSlide>
                ...
                <div className="swiper_item">
                  <div className="swiper_item-head">
                    ...
                    <p className="swiper_item-des">
                    Sở hữu xe VinFast chính là tận hưởng những giá trị tốt nhất của một hệ sinh thái đẳng cấp, từ mô hình O2O tích hợp thương mại điện tử và trải nghiệm tại hệ thống Đại lý/Showroom/Trạm sạc rộng khắp, 
                    </p>
                  </div>
                  <div className="swiper_item-body">
                    <img src={cntm_3} atl="" />
