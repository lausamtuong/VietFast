  ...
  return (
    <div className="Home__wrapper">
      ...
      <div className="block-newhome-videomiddle">
        <div className="v-light">
          <img type="video/mp4" src={vlight_up}/>
        </div>
        <video autoPlay playsInline muted loop>
          <source src={xe_may} type="video/mp4" />
        </video>
      </div>
      <div class="v-light"> <img class="b-lazy" data-original="https://vinfastauto.com/themes/porto/img/Vlight-down.png" alt="v-light" src="https://vinfastauto.com/themes/porto/img/Vlight-down.png" style=""></div>
    </div>
  );
};
