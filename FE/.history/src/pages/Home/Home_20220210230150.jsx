              ...
              <SwiperSlide>
                ...
                <div className="swiper_item">
                  <div className="swiper_item-head">
                    ...
                    <p className="swiper_item-des">
                    VietFast luôn có chính sách bán hàng và hậu mãi có lợi nhất cho khách hàng. VinFast cũng tiên phong thúc đẩy xu hướng sử dụng xe điện, hướng tới tương lai xanh, bền vững bằng chính sách pin và chế độ 
                    </p>
                  </div>
                  <div className="swiper_item-body">
                    <img src={cntm_3} atl="" />
