              ...
              <SwiperSlide>
                ...
                <div className="swiper_item">
                  <div className="swiper_item-head">
                    ...
                    <p className="swiper_item-des">
                    Đặt sự an tâm của khách hàng lên trên hết, những chiếc xe của VinFast được trang bị các tính năng an toàn tối tân nhất để bảo vệ người lái và mọi hành khách trên xe, đáp ứng tiêu chuẩn khắt khe của 
                    </p>
                  </div>
                  <div className="swiper_item-body">
                    <img src={cntm_3} atl="" />
