        ...
        <div className="container-fluid">
          <div class="swiper-wrapper">
            <div>
              ...
              <p>Đặt khách hàng làm trọng tâm, các mẫu xe thông minh của VinFast được ứng dụng những công nghệ <br/>ưu việt hàng đầu thế giới, mở ra không gian hưởng thụ tiện nghi, giải trí hoàn hảo cùng trải nghiệm <br> cá nhân hóa đáng giá nhất.</br></p>
            </div>
