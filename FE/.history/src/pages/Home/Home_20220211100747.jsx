...
const Home = ({ width }) => {
  return (
    <div className="Home__wrapper">
      ...
      <div class="v-light"> 
      <img class="b-lazy" data-original="https://vinfastauto.com/themes/porto/img/Vlight-down.png" alt="v-light" src="https://vinfastauto.com/themes/porto/img/Vlight-down.png" style=""></div>
    </div>
  );
};
