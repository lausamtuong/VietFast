        ...
        <div className="container-fluid">
          <div className="swiper-wrapper">
            <div className="swiper_item">
              <div className="swiper_item-name">
                <h1 className="swiper_item-name">Công nghệ thông minh cho tương lai</h1>
                <p className="swiper_item-des">
                  ...
                  giới, mở ra không gian hưởng thụ tiện nghi, giải trí hoàn hảo
