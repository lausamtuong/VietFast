            ...
            <SwiperSlide>
              ...
              <div className="swiper_item">
                <div className="swiper_item-head">
                  ...
                  <p className="swiper_item-des">
                    Đặt khách hàng làm trọng tâm, các mẫu xe thông minh của
                    VietFast được ứng dụng những công nghệ ưu việt hàng đầu thế
            ...
            <SwiperSlide>
              ...
              <div className="swiper_item">
                <div className="swiper_item-head">
                  <h1 className="swiper_item-name">Thiết kế đầy đam mê</h1>
                  <p className="swiper_item-des">
                    Kết hợp với nhà thiết kế xe nổi tiếng thế giới Pininfarina,
                    VietFast mang đến chất lượng thiết kế đẳng cấp cho từng dòng
                    xe. Theo đuổi triết lý trải nghiệm chạm sinh học, những
                    chiếc xe VietFast sở hữu vẻ ngoài sang trọng đặc trưng cùng
                    khoang nội thất đậm chất tương lai, được chăm chút trong
                    từng chi tiết.
                  </p>
                </div>
                <div className="swiper_item-body">
